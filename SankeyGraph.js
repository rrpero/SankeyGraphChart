...
//onsole.log(html);
				...
				if(!chord){
					...
					[0].forEach(function(i){
						g[i].call(bp[i])
						var fontLabel = (layout.fontSizeLabel+2) + "px QlikView Sans";
						if(orient=="vertical"){
						...
						fontLabel = layout.fontSizeLabel + "px QlikView Sans";
						...
						//if(true){
							...
							var yDown=6;
							var fatorAfastamentoL = layout.spaceLabelLeft*(layout.fontSizeLabel);
							var fatorAfastamentoR = layout.spaceLabelRight*(layout.fontSizeLabel);
						}
						
						//-(d.key.length*(layout.fontSizeLabel/2))
